  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: Icon(Icons.logout), onPressed: _logout, tooltip: 'تسجيل خروج'),
        ],
      ),
      body: Padding(
          ...
          children: [
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(_isUploading ? 'جاري الرفع...' : 'رفع الأرقام', style: TextStyle(fontSize: 18)),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('تنظيف الأرقام المكررة', style: TextStyle(fontSize: 18)),
                style: ElevatedButton.styleFrom(
